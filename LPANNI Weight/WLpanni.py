# -*- coding: utf-8 -*-
"""w-alpha4-check-data.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13Ihc9kVZpbLH1BzoVQIu3rwalV6GDIBB
"""
...
def visual(g):
    ...
    plt.title('My Graph!')
    pos=nx.spring_layout(g, seed=7) # pos = nx.nx_agraph.graphviz_layout(G)
        ...
        for i in neighbors:
            ...
            for j in neighbors:
                if i < j and g.has_edge(i, j):
                    triangle_num += (g[node][i]['Weight'] + g[node][j]['Weight'] + g[i][j]['Weight']) /3
        #print(triangle_num)
        #print(ku)    
        ni = ku + triangle_num
        g.nodes[node]['NI'] = ni
...
#main
def main():
    df = pd.read_csv('family-weight.csv')
    output_file = 'community.txt'
    #edgeList:
    graph = nx.from_pandas_edgelist(df,source="From",target="To", edge_attr='Weight')
    choice = 1
    t = 0
    while choice != 0:
